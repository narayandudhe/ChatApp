...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(com.narayandudhe.chatApp.R.layout.fragment_group, container, false);

        listGroup = GroupDB.getInstance(getContext()).getListGroups();
        recyclerListGroups = (RecyclerView) layout.findViewById(com.narayandudhe.chatApp.R.id.recycleListGroup);
        ...
        progressDialog = new LovelyProgressDialog(getContext())
                .setCancelable(false)
                .setIcon(com.narayandudhe.chatApp.R.drawable.ic_dialog_delete_group)
                .setTitle("Deleting....")
...
class ListGroupsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(com.narayandudhe.chatApp.R.layout.rc_item_group, parent, false);
...
class ItemGroupViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
    ...
    public ItemGroupViewHolder(View itemView) {
        ...
        iconGroup = (TextView) itemView.findViewById(com.narayandudhe.chatApp.R.id.icon_group);
        txtGroupName = (TextView) itemView.findViewById(com.narayandudhe.chatApp.R.id.txtName);
        btnMore = (ImageButton) itemView.findViewById(com.narayandudhe.chatApp.R.id.btnMoreAction);
    }
