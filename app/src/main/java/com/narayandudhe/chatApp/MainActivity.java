...
import com.narayandudhe.chatApp.ui.FriendsFragment;
import com.narayandudhe.chatApp.ui.GroupFragment;
import com.narayandudhe.chatApp.ui.LoginActivity;
import com.narayandudhe.chatApp.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(connected==false)
        {
            Toast.makeText(getApplicationContext(),"You Are Not Connected Internet",Toast.LENGTH_SHORT).show();
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Chat Application By Narayan Dudhe", Toast.LENGTH_LONG).show();
            return true;
        }
